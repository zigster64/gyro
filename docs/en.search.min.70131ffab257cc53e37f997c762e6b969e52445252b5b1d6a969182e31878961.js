...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/gyro/flexsearch.min.js');loadScript('/gyro/en.search-data.min.751189c628f12bf3aa2f9efa4eb93e9cd11fff45cf2176272bd3fafdc814edb9.js',function(){input.required=false;search();});}
